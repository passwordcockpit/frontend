...
export default Component.extend(formValidation, {
  ...
  userSurname: computed('user.surname', {
    get() {
      return this.get('user.surname');
    },
    set(key, value) {
      this.set('user.surname', value);
      return value;
    },
  }),
  init() {
    ...
    save() {
      ...
      if (this.isManageUsers) {
        ...
        if (
          ...
          (repeatnewpass == '' || repeatnewpass == null) &&
          (actual_password == '' || actual_password == null)
        ) {
          user.set('password', undefined);
      ...
      user
        ...
        .then((userData) => {
          ...
          if (
            userData.get('forceLogin') !== undefined &&
            userData.get('forceLogin')
          ) {
